        ...
        <div className="misc-wrapper">
            ...
            <div className="misc-inner p-2 p-sm-3">
                <div className="w-100 text-center">
                    ...
                    <p className="mb-4">
                        Please contact BeautySN if you feel this is incorrect
                    </p>
                    <Button tag={Link} to={accessToken ? userData?.role === 'admin' ? '/admin/dashboard' : '/dashboard' : '/'} color="primary" className="btn-sm-block mb-1">
                        Back to Dashboard
                    </Button>
                    <div className='py-4'>
